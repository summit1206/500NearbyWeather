...
class InfoTableViewController: UITableViewController {
    ...
    private static let cocoaPods: [CocoaPodMeta] = [CocoaPodMeta(name: "Alamofire", urlString: "https://github.com/Alamofire/Alamofire"),
                                                    ...
                                                    CocoaPodMeta(name: "IQKeyboardManager", urlString: "https://github.com/hackiftekhar/IQKeyboardManager")]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 2 && indexPath.row == 0 {
            urlStringValue = "https://github.com/summit1206/500NearbyWeather/blob/master/Contribution"
        }
        ...
        case 0:
            buttonCell.configure(withTitle: NSLocalizedString("InfoTVC_ReportIssue", comment: ""),
                                 ...
                                 leftButtonHandler: { [unowned self] button in
                                    let urlString = "https://github.com/summit1206/500NearbyWeather/issues"
                                 ...
                                 rightButtonHandler: { [unowned self] button in
                                    ...
                                    let subject = "500 NearbyWeather - \(NSLocalizedString("InfoTVC_ReportIssue", comment: ""))"
